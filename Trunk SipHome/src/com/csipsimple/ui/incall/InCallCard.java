...
//    private ViewGroup callSecureBar;
    ...
    private void initControllerView() {
        photo = (ImageView) findViewById(R.id.contact_photo);  //對方照片
        remoteName = (TextView) findViewById(R.id.contact_name_display_name);  //姓名
        remoteSipAddress = (TextView) findViewById(R.id.contact_name_sip_address);  //電話號碼
        elapsedTime = (Chronometer) findViewById(R.id.elapsedTime);  //通話時間
//        callStatusText = (TextView) findViewById(R.id.call_status_text);  //通話狀態
//        callSecureBar = (ViewGroup) findViewById(R.id.call_secure_bar);  //撥進、撥出
//        callSecureText = (TextView) findViewById(R.id.call_secure_text);  //已不使用
        endCallBar = (ViewGroup) findViewById(R.id.end_call_bar);  //結束通話
