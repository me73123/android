...
public class SipService extends Service {
	...
	private final ISipService.Stub binder = new ISipService.Stub() {
        ...
        public void makeCallWithOptions(final String callee, final int accountId, final Bundle options)
        	...
        	Log.d("ruby", "makeCallWithOptions!!!!");
            SipService.this.enforceCallingOrSelfPermission(SipManager.PERMISSION_USE_SIP, null);  //設權限
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void startSipStack() throws SameThreadException {
		//Cache some prefs
		supportMultipleCalls = prefsWrapper.getPreferenceBooleanValue(SipConfigManager.SUPPORT_MULTIPLE_CALLS);  //Preferences中定義values
