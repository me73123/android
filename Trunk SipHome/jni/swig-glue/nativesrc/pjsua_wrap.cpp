...
pj_status_t SwigDirector_Callback::on_validate_audio_clock_rate(int clock_rate) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    jresult = (jint) jenv->CallStaticIntMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[22], swigjobj, jclock_rate);
    if (jenv->ExceptionCheck() == JNI_TRUE) return c_result;
...
void SwigDirector_Callback::on_setup_audio(pj_bool_t before_init) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[23], swigjobj, jbefore_init);
    if (jenv->ExceptionCheck() == JNI_TRUE) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_teardown_audio() {
  ...
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[24], swigjobj);
    if (jenv->ExceptionCheck() == JNI_TRUE) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
int SwigDirector_Callback::on_set_micro_source() {
  ...
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jresult = (jint) jenv->CallStaticIntMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[25], swigjobj);
    if (jenv->ExceptionCheck() == JNI_TRUE) return c_result;
...
void SwigDirector_ZrtpCallback::on_zrtp_show_sas(pjsua_call_id call_id, pj_str_t const *sas, int verified) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pj_str_t **)&jsas) = (pj_str_t *) sas; 
    ...
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[28], swigjobj, jcall_id, jsas, jverified);
    if (jenv->ExceptionCheck() == JNI_TRUE) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_ZrtpCallback::on_zrtp_update_transport(pjsua_call_id call_id) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jcall_id = (jint) call_id;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[29], swigjobj, jcall_id);
    if (jenv->ExceptionCheck() == JNI_TRUE) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_MobileRegHandlerCallback::on_save_contact(pjsua_acc_id acc_id, pj_str_t contact, int expires) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pj_str_t **)&jcontact) = &contact; 
    ...
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[30], swigjobj, jacc_id, jcontact, jexpires);
    if (jenv->ExceptionCheck() == JNI_TRUE) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
pj_str_t SwigDirector_MobileRegHandlerCallback::on_restore_contact(pjsua_acc_id acc_id) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jacc_id = (jint) acc_id;
    jresult = (jlong) jenv->CallStaticLongMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[31], swigjobj, jacc_id);
    if (jenv->ExceptionCheck() == JNI_TRUE) return c_result;
