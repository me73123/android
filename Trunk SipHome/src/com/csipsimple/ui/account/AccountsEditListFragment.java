...
public class AccountsEditListFragment extends CSSListFragment implements /*OnQuitListener,*/ OnCheckedRowListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final DragnDropListView lv = (DragnDropListView) v.findViewById(android.R.id.list);  //帳戶列表
        ...
        OnClickListener addClickButtonListener = new OnClickListener() {
            ...
            public void onClick(View v) {
                onClickAddAccount();  //彈出快速設定list
            }
        };
        // Header view
        mHeaderView = inflater.inflate(R.layout.generic_add_header_list, container, false);  //新增帳戶
        mHeaderView.setOnClickListener(addClickButtonListener);
        
        // Empty view
        Button bt = (Button) v.findViewById(android.R.id.empty);  //新增帳戶+
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        showDetails(id, c.getString(c.getColumnIndex(SipProfile.FIELD_WIZARD)));  //編輯帳戶
    }
